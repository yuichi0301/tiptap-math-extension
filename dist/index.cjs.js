...
var evaluatex = require('evaluatex/dist/evaluatex');
...
const InlineMathNode = core.Node.create({
    name: "inlineMath",
    group: "inline",
    inline: true,
    selectable: true,
    ...
    addInputRules() {
        ...
        if (blockRegex !== undefined) {
            inputRules.push(new core.InputRule({
    ...
    addPasteRules() {
        ...
        const blockRegex = getRegexFromOptions("block", this.options);
        if (blockRegex !== undefined) {
            pasteRules.push(new core.PasteRule({
...
const MathExtension = core.Extension.create({
...
exports.InlineMathNode = InlineMathNode;
exports.MATH_EXTENSION_NAME = MATH_EXTENSION_NAME;
exports.MathExtension = MathExtension;
exports.default = MathExtension;
